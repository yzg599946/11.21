...
export default {
  ...
  created() {
    setTimeout(() => {
      this.list = [
        {
          logisticsNumber: "6464165198419",
          orderNumber: "161465161",
          channel: "广点通",
          recipientName: "刘凤华",
          recipientPhone: "15321324154",
          price: "198",
          productName: "产品1121",
          count: "2",
          address: "广东省xx市xx号",
          createTime: "2019-06-01 15:00:00",
          shipTime: "2019-06-01 15:00:00",
          logisticsState: "无状态",
          salesman: "许燕纯",
          operator: "袁洁"
        },
