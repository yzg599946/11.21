<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="渠道项目" width="150px" align="center">
      ...
      <el-table-column label="名字" width="150px" sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="重单" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.repeatOrder }}</span>
        </template>
      </el-table-column>
      <el-table-column label="详细地址" width="500px" align="center">
        <template slot-scope="scope">
