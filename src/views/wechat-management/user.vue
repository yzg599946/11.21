<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="formId" width="200px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.formId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="头像地址" width="250px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="国家" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.country }}</span>
        </template>
      </el-table-column>
      <el-table-column label="省份" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.province }}</span>
        </template>
      </el-table-column>
      <el-table-column label="城市" width="120px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="到期时间" width="200px" align="center">
        <template slot-scope="scope">
    ...
    this.list = [
      {
        ...
        name: "天下第一峰",
        phoneNumber: "",
        formId: "1516316419874616",
        avatarUrl: "https://wx.xxx.com/4646416",
        gender: "男",
        country: "China",
        province: "Zhejiang",
        city: "Wenzhou",
        language: "zh_CN",
        createTime: "2019-06-21 00:45:22",
        maturityTime: "2019-06-28 00:45:22",
        operate: "发送信息"
      },
      {
        id: "10002",
