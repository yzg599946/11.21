<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="渠道项目" width="90px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="总价" width="70px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.price }}</span>
        </template>
      </el-table-column>
      <el-table-column label="重单" width="70px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="支付状态" width="120px" align="center">
        <template slot-scope="scope">
