<template>
  <div class="app-container">
    ...
    <el-table size="mini" border fit :data="list" style="width: 100%;" @cell-click="handleTimeSlot">
      <el-table-column label="用户" :width="device=='desktop'?'300':'100'" align="center">
      ...
      <el-table-column label="地址" :width="device=='desktop'?'500':'100'" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.address }}</span>
        </template>
      </el-table-column>
      <el-table-column label="登陆时间" :width="device=='desktop'?'150':'100'" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.loginTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="登陆状态" :width="device=='desktop'?'150':'100'" align="center">
        <template slot-scope="scope">
