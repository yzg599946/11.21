<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="店铺名称" width="200px" sortable="custom" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.storeName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="商品主图" width="150px" sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="总单量" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.count }}</span>
        </template>
      </el-table-column>
      <el-table-column label="1小时内" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.withInOneHour }}</span>
        </template>
      </el-table-column>
      <el-table-column label="3小时内" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.withInThreeHour }}</span>
        </template>
      </el-table-column>
      <el-table-column label="6小时内" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.withInSixHour }}</span>
        </template>
      </el-table-column>
      <el-table-column label="12小时内" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.withInTwelveHour }}</span>
        </template>
      </el-table-column>
      <el-table-column label="昨天" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.yestoday }}</span>
        </template>
      </el-table-column>
      <el-table-column label="昨日增长率" width="120px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="链接地址" width="120px" align="center">
        <template slot-scope="scope">
        <a :herf="scope.row.linkAddress" target="_blank">点击访问</a>
        </template>
      </el-table-column>
      <el-table-column label="链接渠道" width="120px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.linkChannel }}</span>
        </template>
      </el-table-column>
    </el-table>
    <!-- PC端 分页器 -->
      ...
      this.list = [
        {
          productName: "【爆款】轻便好穿",
          storeName: "帝尚百货专卖店",
          productMainImageUrl: "https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg",
          minPrice: "99",
          createTime: "2019-05-25 09:15:29",
          updateTime: "2019-06-21 11:00:00",
          count: "93000",
          withInOneHour: "0",
          withInThreeHour: "0",
          withInSixHour: "0",
