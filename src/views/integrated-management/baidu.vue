<template>
  <div class="app-container">
    ...
    <div v-else class="filter-mobile">
      <van-button type="info" size="small" @click="handleAddMobile">新增</van-button>
    </div>
    <!-- 列表 -->
    <el-table size="mini" border fit :data="list" style="width: 100%;" @cell-click="handleTimeSlot">
      <el-table-column label="页面" :width="device=='desktop'?'500':'100'" align="center">
      ...
      <el-table-column label="产品" :width="device=='desktop'?'500':'100'" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.product }}</span>
        </template>
      </el-table-column>
      <el-table-column label="价格" :width="device=='desktop'?'500':'100'" align="center">
        <template slot-scope="scope">
