  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select
        class="table-input"
        size="mini"
        v-model="packageAttribute"
        clearable
        filterable
        placeholder="套餐属性"
      >
        <el-option
          v-for="item in packageAttributeOptions"
          :key="item.value"
          :label="item.label"
          :value="item.value"
        ></el-option>
    ...
    >
      ...
      <el-table-column label="套餐属性" width="120px" sortable="custom" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.packageAttribute }}</span>
        </template>
      </el-table-column>
      ...
      list: [
        {
          id: "10001",
          productName: "",
          packageAttribute: "防水腕表",
          name: "张大新",
          phoneNumber: "16888888888",
          count: "1",
          price: "198",
          repeatOrder: "0",
          address: "北京市 市辖区 通州区 永乐店 孔桩",
          createTime: "2019-06-15 09:00:00",
          remarks: "",
          isUseful: "有效单",
          logisticsState: "未导入",
          salesman: "吴隆灼",
